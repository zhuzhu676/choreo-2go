...
const port = process.env.SERVER_PORT || process.env.PORT || 8008;        
const UUID = process.env.UUID || 'eb93a345-ce02-4c36-881d-2478e024d28e'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.kkq.us.kg';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'Il8ke5Dr9v3hgUTS2r';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || ' chore.azubu.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"8de68f6deb2bf47952ea05c9a76e975a","TunnelSecret":"Mmt8l5frklqY12zyK4SzxGXVpn6lnLc8M1k1g8nb6CU=","TunnelID":"1cbbae33-88e9-4688-b325-cdff1c216268"}';
